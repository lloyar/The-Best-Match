...
public class DestroyByBulletsBlue : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "BulletsBlue" || other.tag == "PlayerRed" || other.tag == "PlayerBlue" || other.tag == "Protecter")
        {
            Invoke("DestroygameObject", Destroytime);
            //Destroy(gameObject);
        }
